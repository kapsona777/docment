...
class DashboardController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.dashboard',compact('data','newQty','successQty','patientQty','doctorQty','totalEarning','subscriberQty','monthlyEarning','pendingOrders','currency','doctors','doctorPayments'));
    }
}
