...
class PrescribeController extends Controller
{
    public function index(){
        ...
        return view('admin.prescribe.index',compact('appointments','doctors'));
    }
    ...
    public function show($id){
        ...
        return view('admin.prescribe.show',compact('appointment','currency','setting','contact'));
    }
    ...
    public function search(Request $request){
        ...
        return view('admin.prescribe.ajax-prescribe',compact('appointments'));
    }
}
