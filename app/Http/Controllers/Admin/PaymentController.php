...
class PaymentController extends Controller
{
    public function payment(){
        ...
        return view('admin.payment.index',compact('appointments','doctors','currency','doctorPayments'));
    }
    ...
    public function paymentSearch(Request $request){
        ...
        return view('admin.payment.ajax-payment',compact('appointments','currency','doctors'));
