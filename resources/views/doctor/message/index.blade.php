...
<style>
                        ...
                        <ul class="users">
                            ...
                            <li class="user" id="{{ $user->user->id }}">
                                @php
                                    ...
                                    $count=App\Message::where(['doctor_id'=>$doctor->id,'user_id'=>$user->user->id,'doctor_view'=>0])->count();
                                @endphp
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <img src="{{ $user->user->image ? url($user->user->image) : url($profile_image) }}" alt="user image" class="media-object">
                                    </div>
    ...
    "use strict";
        ...
        $('.user').on('click',function () {
            ...
            $.ajax({
                type: "get",
                url: "{{ url('doctor/get-message/') }}" + "/" + receiver_id, // need to create this route
                data: "",
                cache: false,
