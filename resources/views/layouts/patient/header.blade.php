                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">{{ $text->appointment_modal_title }}</h5>
                            ...
                            <div class="modal-body book-appointment">
                                ...
                                <form action="{{ url('create-appointment') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="">{{ $text->select_department }}</label>
                                    ...
                                    <div class="form-group d-none" id="mobile-modal-doctor-box">
                                        <label for="">{{ $text->select_doctor }}</label>
                                    ...
                                    <div class="form-group d-none" id="mobile-modal-date-box">
                                        <label for="">{{ $text->select_date }}</label>
                                    ...
                                    <div class="form-group d-none" id="mobile-modal-schedule-box">
                                        <label for="">{{ $text->select_schedule }}</label>
                                    ...
                                    <div class="form-group">
                                        <button type="button" class="btn btn-danger" data-dismiss="modal">{{ $text->appointment_close_btn }}</button>
                                        <input type="submit" value="{{ $text->appointment_submit_btn }}" class="btn btn-primary" id="mobile-modal-sub" disabled>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body book-appointment">
                <form action="{{ url('create-appointment') }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">{{ $text->appointment_close_btn }}</button>
                        <input type="submit" value="{{ $text->appointment_submit_btn }}" class="btn btn-primary" id="modal-sub" disabled>
                    </div>
                </form>
