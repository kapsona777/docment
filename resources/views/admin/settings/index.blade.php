                    ...
                    <form action="{{ route('admin.settings.update',$setting->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="save_contact_message" id="" class="form-control">
                                <option {{ $setting->save_contact_message==0 ? 'selected':'' }} value="0">No</option>
                                <option {{ $setting->save_contact_message==1 ? 'selected':'' }} value="1">Yes</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="patient_can_register" id="" class="form-control">
                                <option {{ $setting->patient_can_register==1 ? 'selected':'' }} value="1">Yes</option>
                                <option {{ $setting->patient_can_register==0 ? 'selected':'' }} value="0">No</option>
                            </select>
                        </div>
                        ...
                        {{-- <div class="form-group">
                            ...
                            <select name="text_direction" id="" class="form-control">
                                <option {{ $setting->text_direction=='LTR' ? 'selected':'' }} value="LTR">LTR</option>
                                <option {{ $setting->text_direction=='RTL' ? 'selected':'' }} value="RTL">RTL</option>
                            </select>
                        </div> --}}

                        <div class="form-group">
                            <label for="">Currency Name</label>
                            <input type="text" class="form-control" name="currency_name" value="{{ $setting->currency_name }}">
                        </div>
                        <div class="form-group">
