        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Manage Department Page</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.department.page.update') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="show_navbar" id="show_navbar" class="form-control">
                                <option {{ $navigation->show_department==1 ? 'selected':'' }} value="1">Yes</option>
                                <option {{ $navigation->show_department==0 ? 'selected':'' }} value="0">No</option>
                            </select>
                        </div>
